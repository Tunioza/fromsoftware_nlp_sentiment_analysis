# Decoding the Masochism: NLP Sentiment Analysis of FromSoftware Games ⚔️
...
Project was made for my BSc Thesis and is written entirely in Polish. Whole paper in Polish can be read here link1
